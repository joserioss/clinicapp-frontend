...
export class ConsultaComponent implements OnInit {
  ...
  agregarExamen() {
    /**
     * Primera validacion que no se agrege un examen vacio
     */
    if (this.idExamenSeleccionado > 0) {
    /**
     * Segunda validacion para no agregar el mismo examen
     */
      let cont = 0;
      ...
      if (cont > 0) {
        ...
        /**
         * Para este caso recupero el id de examen, por lo que necesito llenar con los datos correspondientes
         */
  ...
  /**
   * Metodo que habilita el boton registrar solo si estan los siguientes datos listos
   */
